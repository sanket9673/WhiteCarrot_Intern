...
//                       className="border-b border-gray-600 hover:bg-gray-700 transition-colors duration-300"
//                     >
//                       <td className="lg:py-3 lg:px-4 font-medium text-gray-100">
//                         {event.summary}
//                       </td>
//                       <td className="py-3 px-4 text-gray-300">
...
//         className="text-white p-8 rounded-lg shadow-lg bg-black"
//       >
//         <h1 className="text-4xl md:text-4xl lg:text-5xl font-semibold max-w-7xl mx-auto text-center mt-6 relative z-20 lg:py-6 bg-clip-text text-transparent bg-gradient-to-b from-neutral-100 via-neutral-500 to-neutral-700 dark:from-neutral-100 dark:via-white dark:to-white">
//           Hey {userName}, <br /> Achieve More with <Cover>Every Event</Cover>
//         </h1>
...
//         <div className="flex flex-col sm:flex-col lg:flex-row items-center justify-center space-y-6 sm:space-y-6 lg:space-y-0">
//           {/* Sign Out Button */}
//           <motion.div
//             initial={{ opacity: 0, y: 20 }}
//             animate={{ opacity: 1, y: 0 }}
