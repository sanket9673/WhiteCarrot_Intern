...
// 				let k = new Vector3();
// 				k.setFromSphericalCoords(randum(5, 7), randum(radPerDeg * 0, radPerDeg * 360), (i / count) * Math.PI * 2);
// 				return k.toArray();
// 			}).flat();
...
// function preventWrapAround(phi: number): number {
...
// 	  camera.lookAt(0, 0, 0);
// 	//   console.log(time.get() * 0.0002, preventWrapAround(time.get() * 0.0002))
// 	});
...
// export function OrbitBackground() {
//   return (
//     <Canvas gl={{ antialias: true }} style={{ height: "100vh", width: "100vw" }}>
//       <OrbitScene />
//     </Canvas>
//   );
// }
